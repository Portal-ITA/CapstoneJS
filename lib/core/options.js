...
/**
 * This file contains methods specific to dealing with Capstone's options.
 * All exports are added to the Capstone.prototype
 */
...
/**
 * Sets capstone options
 *
 * Example:
 *     capstone.set('user model', 'User') // sets the 'user model' option to `User`
 */
exports.set = function (key, value) {
	...
	switch (key) {
		...
		case 'email rules':
			throw new Error('The option "' + key + '" is no longer supported. See https://github.com/capstonejs/capstone/wiki/0.3.x-to-0.4.x-Changes');
...
/**
 * Sets multiple capstone options.
 *
 * Example:
 *     capstone.options({test: value}) // sets the 'test' option to `value`
 */
...
/**
 * Gets capstone options
 *
 * Example:
 *     capstone.get('test') // returns the 'test' value
 */
 ...
 *
 * Example:
 *     capstone.get('pathOption', 'defaultValue')
 */
