...
var debug = require('debug')('capstone:storage:adapter:fs');
...
/**
	...
	version of Capstone being used.
...
// with Capstone 0.3 or imported schamas... not sure if it's worth it though.

/**
	# Storage Prototype

	Creates a new Capstone Storage instance, and validates and initialises the
