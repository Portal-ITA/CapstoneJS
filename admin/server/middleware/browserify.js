...
var devMode = process.env.CAPSTONE_DEV === 'true';
var devWriteBundles = process.env.CAPSTONE_WRITE_BUNDLES === 'true';
var devWriteDisc = process.env.CAPSTONE_WRITE_DISC === 'true';
