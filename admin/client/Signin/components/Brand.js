/**
 * Renders a logo, defaulting to the Capstone logo if no brand is specified in
 * the configuration
 */
...
const Brand = function (props) {
	// Default to the CapstoneJS logo
	let logo = { src: `${Capstone.adminPath}/images/logo.png`, width: 205, height: 68 };
	if (props.logo) {
