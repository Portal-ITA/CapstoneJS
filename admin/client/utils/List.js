...
List.prototype.createItem = function (formData, callback) {
	xhr({
		url: `${Capstone.adminPath}/api/${this.path}/create`,
		responseType: 'json',
		method: 'POST',
		headers: assign({}, Capstone.csrf.header),
		body: formData,
	}, (err, resp, data) => {
		if (err) callback(err);
...
List.prototype.updateItem = function (id, formData, callback) {
	xhr({
		url: `${Capstone.adminPath}/api/${this.path}/${id}`,
		responseType: 'json',
		method: 'POST',
		headers: assign({}, Capstone.csrf.header),
		body: formData,
...
List.prototype.loadItem = function (itemId, options, callback) {
	...
	let url = Capstone.adminPath + '/api/' + this.path + '/' + itemId;
...
List.prototype.loadItems = function (options, callback) {
	const url = Capstone.adminPath + '/api/' + this.path + buildQueryString(options);
	xhr({
		url: url,
		responseType: 'json',
	}, (err, resp, data) => {
...
List.prototype.getDownloadURL = function (options) {
	const url = Capstone.adminPath + '/api/' + this.path;
	const parts = [];
...
List.prototype.deleteItems = function (itemIds, callback) {
	const url = Capstone.adminPath + '/api/' + this.path + '/delete';
	xhr({
		url: url,
		method: 'POST',
		headers: assign({}, Capstone.csrf.header),
...
List.prototype.reorderItems = function (item, oldSortOrder, newSortOrder, pageOptions, callback) {
	const url = Capstone.adminPath + '/api/' + this.path + '/' + item.id + '/sortOrder/' + oldSortOrder + '/' + newSortOrder + '/' + buildQueryString(pageOptions);
	xhr({
		url: url,
		method: 'POST',
		headers: assign({}, Capstone.csrf.header),
