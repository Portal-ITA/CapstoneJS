/**
 * The Home view is the view one sees at /capstone. It shows a list of all lists,
		...
		return (
			<Container data-screen-id="home">
				<div className="dashboard-header">
					<div className="dashboard-heading">{Capstone.brand}</div>
				</div>
				<div className="dashboard-groups">
					...
					{Capstone.nav.flat ? (
						<Lists
							...
							lists={Capstone.lists}
							spinner={spinner}
						/>
					) : (
						<div>
							{/* Render nav with sections */}
							{Capstone.nav.sections.map((navSection) => {
								return (
							...
							{Capstone.orphanedLists.length ? (
								<Section label="Other" icon="octicon-database">
									<Lists
										counts={this.props.counts}
										lists={Capstone.orphanedLists}
										spinner={spinner}
									/>
								</Section>
							) : null}
