/**
 * The global Footer, displays a link to the website and the current Capstone
 * version in use
 */
...
var Footer = React.createClass({
	...
	renderUser() {
		...
		return (
			<span>
				...
				<a
					href={`${Capstone.adminPath}/${User.path}/${user.id}`}
					tabIndex="-1"
	...
	render() {
		...
		return (
			<footer className={css(classes.footer)} data-capstone-footer>
				<Container>
