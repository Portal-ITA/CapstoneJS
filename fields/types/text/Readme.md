...
Uses the `cropString()` method from [keystone-utils](https://github.com/capstonejs/keystone-utils#conversion-utilities) to crop the value to the specified length.
