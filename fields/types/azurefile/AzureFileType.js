...
function azurefile (list, path, options) {
	...
	if (!this.azurefileconfig) {
		throw new Error('Invalid Configuration\n\n'
			...
			+ 'See http://v4.capstonejs.com/docs/configuration/#services-azure for more information.\n');
	}
	...
	this.azurefileconfig.container = this.azurefileconfig.container || 'capstone';
...
Object.defineProperty(azurefile.prototype, 'azurefileconfig', {
	get: function () {
		return this.options.azurefileconfig || capstone.get('azurefile config');
	},
});
