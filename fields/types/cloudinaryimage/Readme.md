...
See the [Cloudinary configuration documentation](http://v4.capstonejs.com/docs/configuration#services-cloudinary) for details on how to set up Cloudinary in CapstoneJS.
...
If `whenExists` is set to `'retry'`, how many times capstone should try to generate a unique filename before returning an error
