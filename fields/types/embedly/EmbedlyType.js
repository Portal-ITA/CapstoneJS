...
function embedly(list, path, options) {
	...
	if (!capstone.get("embedly api key")) {
		throw new Error(
			"Invalid Configuration\n\n" +
				...
				"See http://v4.capstonejs.com/docs/configuration/#services-embedly for more information.\n"
		);
	}
	...
	if (!options.from) {
		throw new Error(
			"Invalid Configuration\n\n" +
				...
				"See http://v4.capstonejs.com/docs/database/#fieldtypes-embedly for more information.\n"
		);
	}
...
embedly.prototype.addToSchema = function(schema) {
	...
	schema.pre("save", function(next) {
		...
		var api = new EmbedlyAPI({ key: capstone.get("embedly api key") });
