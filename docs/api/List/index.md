...
List is the control point for constructing Capstone's schema's, and related methods. It is used as a prototype in constructing new lists, before they are registered to Capstone, which adds them to the schema.
...
{
  schema: {
    collection: capstone.prefixModel(key),
  },
  noedit: false,
  nocreate: false,
  nodelete: false,
