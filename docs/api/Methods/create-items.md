...
## `capstone.createItems(data:Object[, options:Object, callback:Function])`

Capstone's `createItems` function is a simple but powerful way to populate your database with data.
