...
**This feature of Capstone is now deprecated and you are encouraged to roll your own pagination**

This is a capstone-specific way of retrieving items from `mongo`. It returns a query object, just as `List.model.find()` would. It supports the options
