...
Finally, we want to add this new route to `routes/index.js` and add a new path to our Capstone application.
...
With this routing configured you should be able to start Capstone, go to the new route, and fill out the Event form. The next step will be to receive and process the data.
...
## Congratulations
Well done! You have finished this four-step guide to getting started with Capstone, and you now have a basic Capstone app complete with an API for form handling that adds data to a database. For more information on list options and the field types Capstone supports, browse the [Database Configuration](/documentation/database/) documentation.
