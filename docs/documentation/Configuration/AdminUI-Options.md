...
Allow you to change the TinyMCE skin. Defaults to `capstone`. See [http://www.tinymce.com/wiki.php/Configuration:skin](http://www.tinymce.com/wiki.php/Configuration:skin) for more details.
