export const gettingStarted = {
	...
	items: [{
		label: 'What is Capstone?',
		slug: '',
	}, {
		label: 'Quick Start (yo capstone)',
		slug: '/yo-generator',
	}, {
...
export const guides = {
	...
	items: [{
		...
		label: 'How to create a blog with Capstone',
		slug: '/how-to-create-a-blog-with-capstone',
	}, {
		label: 'How to send emails with Capstone',
