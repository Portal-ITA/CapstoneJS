			...
			<div className={compose(styles.background)}>
				<Container>
					...
					<ul className={compose(styles.list_links)}>
						...
						<li className={compose(styles.list_links_item)}><a className={compose(styles.list_links_anchor)} href="https://github.com/capstonejs/capstone">Github Project</a></li>
						<li className={compose(styles.list_links_item)}><a className={compose(styles.list_links_anchor)} href="https://groups.google.com/forum/#!forum/capstonejs">Google Group</a></li>
						<li className={compose(styles.list_links_item)}><a className={compose(styles.list_links_anchor)} href="http://demo.capstonejs.com/">Demo Website</a></li>
					</ul>
				</Container>
			</div>
		);
