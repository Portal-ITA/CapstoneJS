			...
			<div className={compose(styles.wrapper)}>
				<Container>
					<Row medium="1/2" large="1/2">
						...
						<Col>
							<a href="mailto:contact@capstonejs.com" className={compose(styles.card)}>
								<h3 className={compose(styles.next__heading)}>Get In Touch →</h3>
								<p className={compose(styles.next__text)}>
									If you are using Capstone for a project, interested in contributing, or looking for commercial support, we'd love to hear about it. Please contact us.
								</p>
							</a>
						</Col>
					</Row>
