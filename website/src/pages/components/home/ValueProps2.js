			...
			<div className={compose(styles.wrapper)}>
				<Container>
					<div className={compose(styles.intro)}>
						...
						<p className={compose(styles.subheading)}>There are a lot of frameworks that make decisions for you, and many that take decisions away.<br />Capstone doesn't do that. Use the features that suit you, and replace the ones that don't.</p>
					</div>
					...
					<Row small="1" medium="1/2" large="1/4">
						<Col>
							<ValueProp
								...
								text="Capstone can configure Express for you, or you can take over and treat Capstone like any other Express middleware."
						...
						<Col>
							<ValueProp
								...
								text="Capstone uses Mongoose, the leading ODM for Node.js and MongoDB, and gives you a single place for your schema, validation rules, and logic."
								text2="Anything you can build with MongoDB, you can build with Capstone."
								marginTop="1em"
							/>
						</Col>
						<Col>
							<ValueProp
								...
								text="Capstone is designed to be as light as you want - you can pick and choose the features you want to include."
						...
						<Col>
							<ValueProp
								...
								text2="Capstone is designed to let you use any of them without losing the benefits they provide."
								marginTop="1em"
							/>
						</Col>
					</Row>
