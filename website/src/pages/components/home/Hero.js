...
const Intro = () => (
	<div className={compose(styles.content)}>
		...
		<p className={compose(styles.subHeading)}>
			CapstoneJS is an open source framework for developing database-driven
...
const LatestRelease = () => (
	<div className={compose(styles.release)}>
		...
		<span className={compose(styles.releaseSide)}>
			<a
				href="https://github.com/capstonejs/capstone/releases/"
				style={{ color: "white" }}
				target="_blank"
			>
				See what's new
...
const Projects = () => (
	<div className={compose(styles.projects)}>
		<h6 className={compose(styles.projectsTitle)}>
			Capstone powers websites, apps and APIs for:
		</h6>
