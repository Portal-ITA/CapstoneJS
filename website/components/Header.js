...
const apiUrl = "https://api.github.com/repos/capstonejs/capstone";
		...
		return (
			<header className={compose(styles.navBar)}>
				...
				>
					<Link to="/">
						<img
							...
							alt="CapstoneJS"
							title="Capstone Classic"
						/>
					</Link>
					<span className={compose(styles.logoText)}>Capstone 4</span>
				</div>
				<ul className={compose(styles.navBarCenter)}>
					...
					<li className={compose(styles.navItem)}>
						<a
							href="https://github.com/capstonejs/capstone"
							target="_blank"
							className={compose(styles.navItemLink)}
						>
							Github
					...
					<li className={compose(styles.navItem)}>
						<a
							href="http://community.capstonejs.com/"
							target="_blank"
							className={compose(styles.navItemLink)}
						>
							Community
				...
				>
					<GithubButton
						...
						repo="https://github.com/capstonejs/capstone"
					/>
				</div>
			</header>
		);
